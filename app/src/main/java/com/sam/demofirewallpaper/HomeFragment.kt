...
class HomeFragment : Fragment() {
    ...
    private val wallpapersListAdapter: WallpapersListAdaper = WallpapersListAdaper(wallpapersList, this)
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        wallpapersViewModel.getWallpapersList().observe(viewLifecycleOwner, Observer {
            wallpapersList = it
            wallpapersListAdapter.wallpaperList = wallpapersList
    ...
    operator fun invoke(wallpapers: WallpapersModel) {
        //Clicked on wallpaper Item from the list, Navigate to details fragment
        Log.d("HOME_FRAMGNE_LOG", "Clicked on Item : ")
